...
namespace ITZielArt\TorahVerse\Console\Command;

use ITZielArt\TorahVerse\Model\Cms\HomepageWidgetInit as HomepageWidgetInitModel;
...
class HomepageWidgetInit extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->setDescription('ITZielArt TorahVerse Homepage widget init');
